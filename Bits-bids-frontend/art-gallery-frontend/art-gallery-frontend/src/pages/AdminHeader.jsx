...
const AdminHeader = () => {
  ...
  return (
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-3">
      ...
      {/* <li class="nav-item">
        <Link
          to="/user/supplier/register"
          class="nav-link active"
          aria-current="page"
        >
          <b className="text-color">Add Supplier</b>
        </Link>
      </li> */}

      {/* <li class="nav-item">
        <Link to="/supplier/all" class="nav-link active" aria-current="page">
          <b className="text-color">View Suppliers</b>
        </Link>
      </li> */}
